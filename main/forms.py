...
class MatchCreationForm(ModelForm):
    ...
    class Meta:
        model = Match
        fields = ('player_1', 'player_2', 'forround', 'overall_1', 'overall_2','overall_1_1','overall_1_2','overall_2_1','overall_2_2', 'matchvideo', 'tournament_winner')
        labels = {
            'player_1': 'Player 1',
            'player_2' : 'Player 2',
            'forround' : 'For Round',
            'overall_1' : 'Overall 1',
            'overall_2' : 'Overall 2',
            'overall_1_1' : 'Overall 1_1',
            'overall_1_2' : 'Overall 1_2',
            'overall_2_1' : 'Overall 2_1',
            'overall_2_2' : 'Overall 2_2',
        ...
        widgets = {
            ...
            'overall_1_1' : forms.NumberInput(attrs={'class': 'form-control my-1', 'placeholder' : 'Overall 1_1'}),
            'overall_1_2' : forms.NumberInput(attrs={'class': 'form-control my-1', 'placeholder' : 'Overall 1_2'}),
            'overall_2_1' : forms.NumberInput(attrs={'class': 'form-control my-1', 'placeholder' : 'Overall 2_1'}),
            'overall_2_2' : forms.NumberInput(attrs={'class': 'form-control my-1', 'placeholder' : 'Overall 2_2'}),
